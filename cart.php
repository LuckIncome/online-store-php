        ...
        <div id="block-content">
            <?php
                ...
                switch ($action) 
                {
                    ...
                    echo '
                       <h3 class="title-h3">Способы доставки</h3>
                        <form method="post">
                            ...
                            <h3 class="title-h3">Информация доставки:</h3>  
                            <ul id="info-order">    
                    ';
                    if ($_SESSION['auth'] != 'yes_auth') 
                    {
                        echo '
                           <li>
                               ...
                               <input type="text" name="order_fio" id="order_fio" value="'.$_SESSION['order_fio'].'" />
                               <span class="order_span_style">
                            ...
                            <li>
                                ...
                                <input type="text" name="order_email" id="order_fio" value="'.$_SESSION['order_email'].'" />
                                <span class="order_span_style">
                            ...
                            <li>
                                ...
                                <input type="text" name="order_phone" id="order_fio" value="'.$_SESSION['order_phone'].'" />
                                <span class="order_span_style">
                                    Пример: 8 950 100 12 34
                                </span>
                            </li>
                            <li>
                                <label class="order_label_style" for="order_address">
                                    <span>*</span>
                                    Адрес<br /> доставки
                                </label>
                                <input type="text" name="order_address" id="order_address" value="'.$_SESSION['order_address'].'" />
                                <span>
                                    Пример: г.Москва,<br /> ул.Интузиастов д 18, кв 58
                                </span>
                            </li>  
                        ';                       
                    }
                    echo '
                        <li>
                            <label class="order_label_style" for="order_note">
                                Примечание
                            </label>
                            <textarea name="order_note">'.$_SESSION['order_note'].'</textarea>
                            <span>
                                Уточните информацию о заказе. <br /> Например, удобное время для звонка<br /> нашего менеджера
                            </span>
                        </li>
                    </ul>
                    ...
                    if ($_SESSION['auth'] == 'yes_auth') 
                    {
                        echo '
                            <ul id="list-info">
                                ...
                                <li><strong>Адресс доставки:</strong>'.$_SESSION['auth_address'].'</li>
                        ...
                        echo '
                           <ul id="list-info">
                                ...
                                <li><strong>Адресс доставки:</strong>'.$_SESSION['order_address'].'</li>
