    ...
    <div id="block-body">
        ...
        <div id="block-content">
            ...
            <form method="post">
                ...
                <p align="right"><input type="submit" name="form_submit" id="save_submit" value="Сохранить" /></p>
            </form>
        </div>
        <?php
...
<?php
    ...
    {
        header("Location: index.php"); //если пользователь не авторизирован он перейдет на главную страницу
    }
?>
